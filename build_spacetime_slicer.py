...
def build_parser():
    ...
    parser.add_argument('--camera_ids', default='0', help='Comma-separated IDs or inclusive range, such as 0:30')
    parser.add_argument('--fps', type=int, default=25, help='FPS of the output video')
    parser.add_argument('--start_frame', type=int, default=0, help='Start frame of the ghost effects (inclusive)')
    parser.add_argument('--freeze_frame', type=int, required=True, help='Frame to freeze and end all ghost effects (inclusive)')
    parser.add_argument('--end_frame', type=int, required=True, help='End frame of the input video')
